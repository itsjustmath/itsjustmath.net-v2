---
title: Just Get Started (Calling All Creatives)
...
Taking the advice I’d given to countless other people, I decided to visit The Barnes during an extended layover in Philadelphia. So I made the trek from Old City to the counterintuitively stark building housing the quaint art from a bygone era.
...
Ira Glass famously articulated this period of exploration, experimentation, and iteration what has been termed “the taste gap”:
...
Tim Urban has written more than ninety blog posts over ten years, leading to having his own TED talk, interviewing Elon Musk,<SideNote id="musk">Back when people *actually* still admired him</SideNote> and self-publishing a book. David Foster Wallace wrote thirty-plus short stories and essays before publishing his epic tome, Infinite Jest.
