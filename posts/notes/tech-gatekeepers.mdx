...
tags: 
type: 'note'
notes: start thinking about what kind of media/imagery I want to include in here (monks, gatekeepers vs. moat, d3 timeline)
---

# Technology & Traditional Gatekeepers[^essayQuestion]
...
### (Introduce the Opportunity/Risk)
...
### (Setup structure of rest of piece / brief hint at Takeaway)

Regardless of which way things go ~~(the ship gets steered?)~~, I can assure you that you will need to adapt, or risk getting left behind. AI (and its eventual ~~subsequent~~ successors) are going to change the way we work, the way we consume media, and the way that we interact with technology, {and way we interact with each other}. While this can seem daunting, I believe (and have seen that) there is real opportunity here for those who {learn the ropes|push the boundaries} and seize it.
...
## (The duality of technology (+ how tech shapes us))

### (Re-introduce the concept?)

There have been numerous times throughout our history that humans have created new tools or technology that have significantly changed the course of our development.

We create tools to serve a purpose us, but those tools then influence the way we think~~, act,~~ and interact with the world.[^mcluhanTools]

Some[^techFocus] of these advancements (and their effects) include: 
- **Writing systems**: enabled better communication, record-keeping, knowledge preservation/transfer
- **Printing press**: enabled spreading of information and literacy
- **Computers**: enabled complex calculations and digital data manipulation — revolutionizing information storage, processing, and retrieval
- **The Internet**: enabled a global revolution of communication, commerce and information sharing
- **Smartphones**: combined/replaced many tools, transformed communication and access to information

It's hard to judge these inventions as net good or bad, until we're looking at them in retrospect. Does the most recent disruptive technology, AI, deserve a place on this list?[^differenceWithAI] *I think that remains to be seen*.[^reviewRebuttals]

One thing is for sure though, these more recent technological advances seem to be {happening} exponentially faster.[^mooresLaw] And these recent developments **enable us to do more with less, at increasing speeds.**

[But now with technology advancing faster than our government can regulate it, and the advances happening faster than our Paleolithic brains can evolve]

[a lot of the more recent advances (with potential to change things) have been overtaken by capitalists[^capitalistRebuttal], by short-sighted attempts to capitalize]...without really knowing the 





### (Elaborate the risks of any new technology)


### (Elaborate on the opportunities[^opportunitiesElaboration])



[^essayQuestion]:  Is this an article about technological advances, or about AI? Should they be broken into separate articles? *Should it be a series?* (if series, how would I even do that?)
...
[^braveNewWorld]: TODO: pull in quote from my other essay about people "loving their oppression"
...
[^opportunitiesElaboration]: Elaborate on the opportunities of *any* new technology, or specifically this one? (ie. AI)
[^someTools]: I know I'm skipping a lot of them (but maybe I should just focus on media/medium related ones
[^capitalistRebuttal]: What about the rebuttal that capitalism has lifted so many people out over poverty? (And its created so many of the opportunities and luxuries that we have come to enjoy, including our cities)
[^techFocus]: For this essay, I'm going to narrow on the ones related information, communication, and media
[^mcluhanTools]: "We shape our tools and thereafter our tools shape us." - Marshall McLuhan 
[^reviewRebuttals]: TODO: maybe review those AI-related articles about it being overblown)
[^mooresLaw]: Due to Moore's Law?
[^differenceWithAI]: To me, the difference now (with AI) is that there is  much more of a black box effect — we give the machine a set of instructions but we don't have insight into how it arrived at what it outputs (i.e. it is so situational/context driven)